...
import { Zap as ZapIcon, Target, Crown, Flame, Trophy, Shield, Activity, Aperture, Award as AwardIconLucide, Briefcase, CalendarCheck, CheckCircle, Compass, Cpu, Disc, DollarSign, Feather as FeatherIcon, FileText, Filter, Flag, Folder, Globe, Grid, HardDrive, HelpCircle, Inbox, Layers, LifeBuoy, Link, MapPin, Maximize, Mic, Minimize, Monitor, Moon, MousePointer, Package, Percent, PieChart, Pilcrow, Pocket, Power, Printer, Radio, Save, Scissors, Server, Share2, ShoppingBag, Shuffle, Sidebar, Smile, Speaker, Square, Star as StarIcon, Sun, Sunset, Sunrise, Tag, Terminal, Wrench as Tool, Trash2, TrendingUp, TrendingDown, Umbrella, UploadCloud, UserCheck, UserCog, UserMinus, UserPlus as UserPlusIcon, Users, Video, Voicemail, Watch, Wifi, Wind, ZapOff, ZoomIn, ZoomOut, Send, Instagram, Twitter, Facebook, Youtube, Twitch, Shirt, Gem, Eye, Palette, Diamond, Rocket, BookOpen, BarChartHorizontalBig, Lightbulb } from 'lucide-react';
...
export const UPGRADES = [
  { id: 'auto늪지', name: 'Ciénaga Automática', description: 'Genera 1 moneda por segundo', basePrice: 50, basePower: 1, icon: Activity, color: 'text-green-400', type: 'cps' },
  { id: 'mordiscoPoderoso', name: 'Mordisco Poderoso', description: 'Aumenta monedas por clic en +1', basePrice: 100, basePower: 1, icon: Target, color: 'text-red-500', type: 'click' },
  { id: 'cazadorSigiloso', name: 'Cazador Sigiloso', description: 'Genera 5 monedas por segundo', basePrice: 500, basePower: 5, icon: Compass, color: 'text-teal-400', type: 'cps' },
  { id: 'superCocodrilo', name: 'Super Cocodrilo', description: 'Multiplica monedas por clic x1.5', basePrice: 1000, basePower: 1.5, icon: Flame, color: 'text-orange-500', type: 'multiplier' },
  { id: 'criaderoMasivo', name: 'Criadero Masivo', description: 'Genera 25 monedas por segundo', basePrice: 5000, basePower: 25, icon: Users, color: 'text-lime-400', type: 'cps' },
  { id: 'escamasReforzadas', name: 'Escamas Reforzadas', description: 'Aumenta monedas por clic en +10', basePrice: 2500, basePower: 10, icon: Shield, color: 'text-gray-400', type: 'click' },
  { id: 'reyDelPantano', name: 'Rey del Pantano', description: 'Genera 100 monedas por segundo', basePrice: 20000, basePower: 100, icon: Crown, color: 'text-yellow-400', type: 'cps' },
];
...
export const MISSIONS = [
  ...
  },
  {
    ...
    requirement: { type: 'social_share', value: 1, url: 'https://twitter.com/intent/tweet?text=¡Jugando%20Cocodrilo%20Kombat!%20%23CocodriloKombat%20%23PlayToEarn&url=YOUR_GAME_URL_HERE', actionText: 'Compartir en X' },
  ...
  },
  {
    ...
    requirement: { type: 'social_follow', value: 1, url: 'https://t.me/yourchannel', actionText: 'Unirse a Telegram' },
    reward: { coins: 250, xp: 50 },
    icon: UserPlusIcon,
    category: 'Social'
  }
